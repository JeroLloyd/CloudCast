...
export default function ForecastCard({ forecast, unit }: { forecast: ForecastDay[], unit: string }) {
  ...
  return (
    <div className="mt-3 backdrop-blur-xl bg-white/10 rounded-2xl p-3 sm:p-4 border border-white/20 animate-fade-in">
      <h3 className="text-white font-light text-sm sm:text-base mb-2">5-Day Forecast</h3>
      <div className="grid grid-cols-5 gap-1.5 sm:gap-2">
        {forecast.slice(0, 5).map((day, i) => (
          <div key={i} className="text-center backdrop-blur-lg bg-white/5 rounded-xl p-1.5 hover:bg-white/10 transition-all">
