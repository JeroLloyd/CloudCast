...
export default function SunTimes({ sunrise, sunset }: { sunrise: number, sunset: number }) {
  ...
  return (
    <div className="mt-3 backdrop-blur-xl bg-white/10 rounded-2xl p-3 border border-white/20 animate-fade-in">
      <h3 className="text-white font-light text-sm mb-2">Sun Schedule</h3>
      <div className="grid grid-cols-2 gap-2">
        <div className="flex items-center gap-2 backdrop-blur-lg bg-white/5 rounded-xl p-2">
          <SunIcon className="w-8 h-8 text-yellow-300 flex-shrink-0" />
          <div>
        ...
        <div className="flex items-center gap-2 backdrop-blur-lg bg-white/5 rounded-xl p-2">
          <SunIcon className="w-8 h-8 text-orange-400 flex-shrink-0" />
          <div>
